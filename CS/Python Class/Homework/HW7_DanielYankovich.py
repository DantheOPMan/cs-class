...
print(litCricFriend(["a", "an"], heBells))
print(litCricFriend(["a", "an"], cantoXII))
print(litCricFriend(["the"], heBells))
...
Yes. It shows that poe uses 'a', 'an', and 'the' way more than neruda uses as their ratios are much higher, 3x for 'a' and 'an', 2.5x for 'the'.
'''